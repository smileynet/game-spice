...
- `(see game-antipatterns/timing-antipatterns.md → Core Loop Neglect)`
...
- `(see game-antipatterns/scope-antipatterns.md → Premature Content)`
...
- Batch size should match your playtest cadence `(see game-playtesting)`
