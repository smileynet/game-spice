...
- `(see game-mechanics-palette/palette.md for all 10 mechanic categories with full tables and design notes)`
- `(see game-mechanics-palette/mashups.md for mashup pattern deep dive: Loop Nesting, Verb+Context Shift, Opposing Forces, Scale Shift, System Merger)`
- `(see game-mechanics-palette/exploration-prompts.md for guided 6-step discovery process for brainstorming sessions)`
