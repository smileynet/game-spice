...
**Design notes:** Collection mechanics feed other systems — they're taps in your economy. The act of collecting should be satisfying on its own (good game feel), not just a chore to fuel crafting `(see game-economy-design)`.
...
**Design notes:** Progression mechanics are how your game stays interesting over hours, not minutes. The best progression expands *options* (horizontal) rather than just *numbers* (vertical) `(see game-design-frameworks/progression.md)`.
