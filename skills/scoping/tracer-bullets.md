...
A tracer bullet is your *first* vertical slice. Subsequent slices widen the game by adding new paths through these same 5 layers. `(see scoping/vertical-slices.md for decomposition techniques and antipatterns)`
